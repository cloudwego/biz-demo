...
import (
	...
	"github.com/cloudwego/biz-demo/mall/cmd/cmp_ecom_product/kitex_gen/base"
	"strings"
)

type ModifySource int64

const (
	ModifySource_Shop       ModifySource = 0
	ModifySource_Governance ModifySource = 1
)

func (p ModifySource) String() string {
	switch p {
	case ModifySource_Shop:
		return "Shop"
	case ModifySource_Governance:
		return "Governance"
	}
	return "<UNSET>"
}

func ModifySourceFromString(s string) (ModifySource, error) {
	switch s {
	case "Shop":
		return ModifySource_Shop, nil
	case "Governance":
		return ModifySource_Governance, nil
	}
	return ModifySource(0), fmt.Errorf("not a valid ModifySource string")
}

func ModifySourcePtr(v ModifySource) *ModifySource { return &v }

func (p *ModifySource) Scan(value interface{}) (err error) {
	var result sql.NullInt64
	err = result.Scan(value)
	*p = ModifySource(result.Int64)
	return
}

func (p *ModifySource) Value() (driver.Value, error) {
	if p == nil {
		return nil, nil
	}
	return int64(*p), nil
...
func (p AuditStatus) String() string {
	switch p {
	case AuditStatus_Pending:
		return "Pending"
	case AuditStatus_Pass:
		return "Pass"
	case AuditStatus_Reject:
		return "Reject"
	}
	return "<UNSET>"
}
...
func AuditStatusFromString(s string) (AuditStatus, error) {
	switch s {
	case "Pending":
		return AuditStatus_Pending, nil
	case "Pass":
		return AuditStatus_Pass, nil
	case "Reject":
		return AuditStatus_Reject, nil
	}
...
type PassProductReq struct {
	ProductId int64 `thrift:"ProductId,1" json:"ProductId"`
}

func NewPassProductReq() *PassProductReq {
	return &PassProductReq{}
}

func (p *PassProductReq) GetProductId() (v int64) {
	return p.ProductId
}
func (p *PassProductReq) SetProductId(val int64) {
	p.ProductId = val
}

var fieldIDToName_PassProductReq = map[int16]string{
	1: "ProductId",
}

func (p *PassProductReq) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_PassProductReq[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *PassProductReq) ReadField1(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadI64(); err != nil {
		return err
	} else {
		p.ProductId = v
...
func (p *PassProductReq) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("PassProductReq"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *PassProductReq) writeField1(oprot thrift.TProtocol) (err error) {
...
func (p *PassProductReq) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("PassProductReq(%+v)", *p)
}

func (p *PassProductReq) DeepEqual(ano *PassProductReq) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *PassProductReq) Field1DeepEqual(src int64) bool {
...
type PassProductResp struct {
	BaseResp *base.BaseResp `thrift:"BaseResp,255" json:"BaseResp"`
}

func NewPassProductResp() *PassProductResp {
	return &PassProductResp{}
}

var PassProductResp_BaseResp_DEFAULT *base.BaseResp

func (p *PassProductResp) GetBaseResp() (v *base.BaseResp) {
	if !p.IsSetBaseResp() {
		return PassProductResp_BaseResp_DEFAULT
	}
	return p.BaseResp
}
func (p *PassProductResp) SetBaseResp(val *base.BaseResp) {
	p.BaseResp = val
}

var fieldIDToName_PassProductResp = map[int16]string{
	255: "BaseResp",
}

func (p *PassProductResp) IsSetBaseResp() bool {
	return p.BaseResp != nil
}

func (p *PassProductResp) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_PassProductResp[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *PassProductResp) ReadField255(iprot thrift.TProtocol) error {
	p.BaseResp = base.NewBaseResp()
	if err := p.BaseResp.Read(iprot); err != nil {
		return err
	}
...
func (p *PassProductResp) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("PassProductResp"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField255(oprot); err != nil {
...
func (p *PassProductResp) writeField255(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("BaseResp", thrift.STRUCT, 255); err != nil {
		goto WriteFieldBeginError
	}
	if err := p.BaseResp.Write(oprot); err != nil {
...
func (p *PassProductResp) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("PassProductResp(%+v)", *p)
}

func (p *PassProductResp) DeepEqual(ano *PassProductResp) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *PassProductResp) Field255DeepEqual(src *base.BaseResp) bool {
...
type RejectProductReq struct {
	ProductId    int64  `thrift:"ProductId,1" json:"ProductId"`
	RejectReason string `thrift:"RejectReason,2" json:"RejectReason"`
}

func NewRejectProductReq() *RejectProductReq {
	return &RejectProductReq{}
}

func (p *RejectProductReq) GetProductId() (v int64) {
	return p.ProductId
}

func (p *RejectProductReq) GetRejectReason() (v string) {
	return p.RejectReason
}
func (p *RejectProductReq) SetProductId(val int64) {
	p.ProductId = val
}
func (p *RejectProductReq) SetRejectReason(val string) {
	p.RejectReason = val
}

var fieldIDToName_RejectProductReq = map[int16]string{
	1: "ProductId",
	2: "RejectReason",
}

func (p *RejectProductReq) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_RejectProductReq[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *RejectProductReq) ReadField1(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadI64(); err != nil {
		return err
	} else {
		p.ProductId = v
...
func (p *RejectProductReq) ReadField2(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadString(); err != nil {
		return err
	} else {
		p.RejectReason = v
...
func (p *RejectProductReq) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("RejectProductReq"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *RejectProductReq) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("ProductId", thrift.I64, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteI64(p.ProductId); err != nil {
...
func (p *RejectProductReq) writeField2(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("RejectReason", thrift.STRING, 2); err != nil {
		goto WriteFieldBeginError
	}
...
func (p *RejectProductReq) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("RejectProductReq(%+v)", *p)
}

func (p *RejectProductReq) DeepEqual(ano *RejectProductReq) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
	...
	if !p.Field2DeepEqual(ano.RejectReason) {
		return false
	}
	return true
}

func (p *RejectProductReq) Field1DeepEqual(src int64) bool {
...
func (p *RejectProductReq) Field2DeepEqual(src string) bool {

	if strings.Compare(p.RejectReason, src) != 0 {
		return false
	}
	return true
}

type RejectProductResp struct {
	BaseResp *base.BaseResp `thrift:"BaseResp,255" json:"BaseResp"`
}

func NewRejectProductResp() *RejectProductResp {
	return &RejectProductResp{}
}

var RejectProductResp_BaseResp_DEFAULT *base.BaseResp

func (p *RejectProductResp) GetBaseResp() (v *base.BaseResp) {
	if !p.IsSetBaseResp() {
		return RejectProductResp_BaseResp_DEFAULT
	}
	return p.BaseResp
}
func (p *RejectProductResp) SetBaseResp(val *base.BaseResp) {
	p.BaseResp = val
}

var fieldIDToName_RejectProductResp = map[int16]string{
	255: "BaseResp",
}

func (p *RejectProductResp) IsSetBaseResp() bool {
	return p.BaseResp != nil
}

func (p *RejectProductResp) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_RejectProductResp[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *RejectProductResp) ReadField255(iprot thrift.TProtocol) error {
	p.BaseResp = base.NewBaseResp()
	if err := p.BaseResp.Read(iprot); err != nil {
		return err
	}
...
func (p *RejectProductResp) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("RejectProductResp"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField255(oprot); err != nil {
...
func (p *RejectProductResp) writeField255(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("BaseResp", thrift.STRUCT, 255); err != nil {
		goto WriteFieldBeginError
	}
	if err := p.BaseResp.Write(oprot); err != nil {
...
func (p *RejectProductResp) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("RejectProductResp(%+v)", *p)
}

func (p *RejectProductResp) DeepEqual(ano *RejectProductResp) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *RejectProductResp) Field255DeepEqual(src *base.BaseResp) bool {
...
type ProductService interface {
	...
	PassProduct(ctx context.Context, req *PassProductReq) (r *PassProductResp, err error)

	RejectProduct(ctx context.Context, req *RejectProductReq) (r *RejectProductResp, err error)
}
...
func (p *ProductServiceClient) PassProduct(ctx context.Context, req *PassProductReq) (r *PassProductResp, err error) {
	var _args ProductServicePassProductArgs
	_args.Req = req
	var _result ProductServicePassProductResult
	if err = p.Client_().Call(ctx, "PassProduct", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}

func (p *ProductServiceClient) RejectProduct(ctx context.Context, req *RejectProductReq) (r *RejectProductResp, err error) {
	var _args ProductServiceRejectProductArgs
	_args.Req = req
	var _result ProductServiceRejectProductResult
	if err = p.Client_().Call(ctx, "RejectProduct", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
...
func NewProductServiceProcessor(handler ProductService) *ProductServiceProcessor {
	...
	self.AddToProcessorMap("PassProduct", &productServiceProcessorPassProduct{handler: handler})
	self.AddToProcessorMap("RejectProduct", &productServiceProcessorRejectProduct{handler: handler})
	return self
}
...
type productServiceProcessorPassProduct struct {
	handler ProductService
}

func (p *productServiceProcessorPassProduct) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := ProductServicePassProductArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
		oprot.WriteMessageBegin("PassProduct", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush(ctx)
		return false, err
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := ProductServicePassProductResult{}
	var retval *PassProductResp
	if retval, err2 = p.handler.PassProduct(ctx, args.Req); err2 != nil {
		x := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing PassProduct: "+err2.Error())
		oprot.WriteMessageBegin("PassProduct", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush(ctx)
	...
	if err2 = oprot.WriteMessageBegin("PassProduct", thrift.REPLY, seqId); err2 != nil {
		err = err2
	}
	if err2 = result.Write(oprot); err == nil && err2 != nil {
		err = err2
...
type productServiceProcessorRejectProduct struct {
	handler ProductService
}

func (p *productServiceProcessorRejectProduct) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := ProductServiceRejectProductArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
		oprot.WriteMessageBegin("RejectProduct", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush(ctx)
		return false, err
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := ProductServiceRejectProductResult{}
	var retval *RejectProductResp
	if retval, err2 = p.handler.RejectProduct(ctx, args.Req); err2 != nil {
		x := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing RejectProduct: "+err2.Error())
		oprot.WriteMessageBegin("RejectProduct", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush(ctx)
	...
	if err2 = oprot.WriteMessageBegin("RejectProduct", thrift.REPLY, seqId); err2 != nil {
		err = err2
	}
	if err2 = result.Write(oprot); err == nil && err2 != nil {
		err = err2
...
type ProductServicePassProductArgs struct {
	Req *PassProductReq `thrift:"req,1" json:"req"`
}

func NewProductServicePassProductArgs() *ProductServicePassProductArgs {
	return &ProductServicePassProductArgs{}
}

var ProductServicePassProductArgs_Req_DEFAULT *PassProductReq

func (p *ProductServicePassProductArgs) GetReq() (v *PassProductReq) {
	if !p.IsSetReq() {
		return ProductServicePassProductArgs_Req_DEFAULT
	}
	return p.Req
}
func (p *ProductServicePassProductArgs) SetReq(val *PassProductReq) {
	p.Req = val
}

var fieldIDToName_ProductServicePassProductArgs = map[int16]string{
	1: "req",
}

func (p *ProductServicePassProductArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *ProductServicePassProductArgs) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_ProductServicePassProductArgs[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *ProductServicePassProductArgs) ReadField1(iprot thrift.TProtocol) error {
	p.Req = NewPassProductReq()
	if err := p.Req.Read(iprot); err != nil {
		return err
	}
	return nil
...
func (p *ProductServicePassProductArgs) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("PassProduct_args"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *ProductServicePassProductArgs) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("req", thrift.STRUCT, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := p.Req.Write(oprot); err != nil {
...
func (p *ProductServicePassProductArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("ProductServicePassProductArgs(%+v)", *p)
}

func (p *ProductServicePassProductArgs) DeepEqual(ano *ProductServicePassProductArgs) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *ProductServicePassProductArgs) Field1DeepEqual(src *PassProductReq) bool {
...
type ProductServicePassProductResult struct {
	Success *PassProductResp `thrift:"success,0" json:"success,omitempty"`
}

func NewProductServicePassProductResult() *ProductServicePassProductResult {
	return &ProductServicePassProductResult{}
}

var ProductServicePassProductResult_Success_DEFAULT *PassProductResp

func (p *ProductServicePassProductResult) GetSuccess() (v *PassProductResp) {
	if !p.IsSetSuccess() {
		return ProductServicePassProductResult_Success_DEFAULT
	}
	return p.Success
}
func (p *ProductServicePassProductResult) SetSuccess(x interface{}) {
	p.Success = x.(*PassProductResp)
}

var fieldIDToName_ProductServicePassProductResult = map[int16]string{
	0: "success",
}

func (p *ProductServicePassProductResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *ProductServicePassProductResult) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_ProductServicePassProductResult[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *ProductServicePassProductResult) ReadField0(iprot thrift.TProtocol) error {
	p.Success = NewPassProductResp()
	if err := p.Success.Read(iprot); err != nil {
		return err
	}
	return nil
...
func (p *ProductServicePassProductResult) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("PassProduct_result"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField0(oprot); err != nil {
...
func (p *ProductServicePassProductResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
		if err = oprot.WriteFieldBegin("success", thrift.STRUCT, 0); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *ProductServicePassProductResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("ProductServicePassProductResult(%+v)", *p)
}

func (p *ProductServicePassProductResult) DeepEqual(ano *ProductServicePassProductResult) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *ProductServicePassProductResult) Field0DeepEqual(src *PassProductResp) bool {
...
type ProductServiceRejectProductArgs struct {
	Req *RejectProductReq `thrift:"req,1" json:"req"`
}

func NewProductServiceRejectProductArgs() *ProductServiceRejectProductArgs {
	return &ProductServiceRejectProductArgs{}
}

var ProductServiceRejectProductArgs_Req_DEFAULT *RejectProductReq

func (p *ProductServiceRejectProductArgs) GetReq() (v *RejectProductReq) {
	if !p.IsSetReq() {
		return ProductServiceRejectProductArgs_Req_DEFAULT
	}
	return p.Req
}
func (p *ProductServiceRejectProductArgs) SetReq(val *RejectProductReq) {
	p.Req = val
}

var fieldIDToName_ProductServiceRejectProductArgs = map[int16]string{
	1: "req",
}

func (p *ProductServiceRejectProductArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *ProductServiceRejectProductArgs) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_ProductServiceRejectProductArgs[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *ProductServiceRejectProductArgs) ReadField1(iprot thrift.TProtocol) error {
	p.Req = NewRejectProductReq()
	if err := p.Req.Read(iprot); err != nil {
		return err
	}
	return nil
...
func (p *ProductServiceRejectProductArgs) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("RejectProduct_args"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *ProductServiceRejectProductArgs) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("req", thrift.STRUCT, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := p.Req.Write(oprot); err != nil {
...
func (p *ProductServiceRejectProductArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("ProductServiceRejectProductArgs(%+v)", *p)
}

func (p *ProductServiceRejectProductArgs) DeepEqual(ano *ProductServiceRejectProductArgs) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *ProductServiceRejectProductArgs) Field1DeepEqual(src *RejectProductReq) bool {
...
type ProductServiceRejectProductResult struct {
	Success *RejectProductResp `thrift:"success,0" json:"success,omitempty"`
}

func NewProductServiceRejectProductResult() *ProductServiceRejectProductResult {
	return &ProductServiceRejectProductResult{}
}

var ProductServiceRejectProductResult_Success_DEFAULT *RejectProductResp

func (p *ProductServiceRejectProductResult) GetSuccess() (v *RejectProductResp) {
	if !p.IsSetSuccess() {
		return ProductServiceRejectProductResult_Success_DEFAULT
	}
	return p.Success
}
func (p *ProductServiceRejectProductResult) SetSuccess(x interface{}) {
	p.Success = x.(*RejectProductResp)
}

var fieldIDToName_ProductServiceRejectProductResult = map[int16]string{
	0: "success",
}

func (p *ProductServiceRejectProductResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *ProductServiceRejectProductResult) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_ProductServiceRejectProductResult[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *ProductServiceRejectProductResult) ReadField0(iprot thrift.TProtocol) error {
	p.Success = NewRejectProductResp()
	if err := p.Success.Read(iprot); err != nil {
		return err
	}
	return nil
...
func (p *ProductServiceRejectProductResult) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("RejectProduct_result"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField0(oprot); err != nil {
...
func (p *ProductServiceRejectProductResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
		if err = oprot.WriteFieldBegin("success", thrift.STRUCT, 0); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *ProductServiceRejectProductResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("ProductServiceRejectProductResult(%+v)", *p)
}

func (p *ProductServiceRejectProductResult) DeepEqual(ano *ProductServiceRejectProductResult) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *ProductServiceRejectProductResult) Field0DeepEqual(src *RejectProductResp) bool {
