...
import (
	"context"
	"github.com/cloudwego/biz-demo/mall/cmd/cmp_ecom_api/kitex_gen/cmp/ecom/product"
...
func NewServiceInfo() *kitex.ServiceInfo {
	...
	methods := map[string]kitex.MethodInfo{
		...
		"PassProduct":       kitex.NewMethodInfo(passProductHandler, newProductServicePassProductArgs, newProductServicePassProductResult, false),
		"RejectProduct":     kitex.NewMethodInfo(rejectProductHandler, newProductServiceRejectProductArgs, newProductServiceRejectProductResult, false),
	}
...
func passProductHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	realArg := arg.(*product.ProductServicePassProductArgs)
	realResult := result.(*product.ProductServicePassProductResult)
	success, err := handler.(product.ProductService).PassProduct(ctx, realArg.Req)
	if err != nil {
		return err
	}
	realResult.Success = success
...
func newProductServicePassProductArgs() interface{} {
	return product.NewProductServicePassProductArgs()
}

func newProductServicePassProductResult() interface{} {
	return product.NewProductServicePassProductResult()
}

func rejectProductHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	realArg := arg.(*product.ProductServiceRejectProductArgs)
	realResult := result.(*product.ProductServiceRejectProductResult)
	success, err := handler.(product.ProductService).RejectProduct(ctx, realArg.Req)
	if err != nil {
		return err
	}
	realResult.Success = success
...
func newProductServiceRejectProductArgs() interface{} {
	return product.NewProductServiceRejectProductArgs()
}

func newProductServiceRejectProductResult() interface{} {
	return product.NewProductServiceRejectProductResult()
}
...
func (p *kClient) PassProduct(ctx context.Context, req *product.PassProductReq) (r *product.PassProductResp, err error) {
	var _args product.ProductServicePassProductArgs
	_args.Req = req
	var _result product.ProductServicePassProductResult
	if err = p.c.Call(ctx, "PassProduct", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}

func (p *kClient) RejectProduct(ctx context.Context, req *product.RejectProductReq) (r *product.RejectProductResp, err error) {
	var _args product.ProductServiceRejectProductArgs
	_args.Req = req
	var _result product.ProductServiceRejectProductResult
	if err = p.c.Call(ctx, "RejectProduct", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
