...
import (
	...
	"github.com/cloudwego/kitex-examples/bizdemo/easy_note/pkg/utils"
...
func CommonMiddleware(next endpoint.Endpoint) endpoint.Endpoint {
	return func(ctx context.Context, req, resp interface{}) (err error) {
		...
		// get real request
		klog.CtxInfof(ctx, "real request: %+s\n", utils.StructToString(req))
		...
		// get real response
		klog.CtxInfof(ctx, "real response: %+s\n", utils.StructToString(resp))
		return nil
	}
}
