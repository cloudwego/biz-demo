...
import (
	"context"
	product "github.com/cloudwego/biz-demo/gomall/app/checkout/kitex_gen/product"
...
func (p *kProductCatalogServiceClient) ListProducts(ctx context.Context, Req *product.ListProductsReq, callOptions ...callopt.Option) (r *product.ListProductsResponse, err error) {
