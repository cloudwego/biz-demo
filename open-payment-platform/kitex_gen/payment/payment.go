...
func (p *CallBackResp) Read(iprot thrift.TProtocol) (err error) {
...
func (p *CallBackResp) Write(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteStructBegin("CallBackResp"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
...
func (p *CallBackResp) DeepEqual(ano *CallBackResp) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
