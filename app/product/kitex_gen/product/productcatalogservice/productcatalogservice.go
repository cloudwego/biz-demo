...
func (p *ListProductsArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, fmt.Errorf("No req in ListProductsArgs")
	}
...
var ListProductsArgs_Req_DEFAULT *product.Empty

func (p *ListProductsArgs) GetReq() *product.Empty {
	if !p.IsSetReq() {
...
func (p *ListProductsResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, fmt.Errorf("No req in ListProductsResult")
	}
...
func (p *SearchProductsArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, fmt.Errorf("No req in SearchProductsArgs")
	}
	return proto.Marshal(p.Req)
}
...
func (p *SearchProductsResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, fmt.Errorf("No req in SearchProductsResult")
	}
	return proto.Marshal(p.Success)
}
...
func (p *kClient) ListProducts(ctx context.Context, Req *product.Empty) (r *product.ListProductsResponse, err error) {
