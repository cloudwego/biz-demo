...
func NewServiceInfo() *kitex.ServiceInfo {
	...
	handlerType := (*order.CheckoutService)(nil)
...
func placeOrderHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(order.CheckoutService).PlaceOrder(ctx, req)
		if err != nil {
			return err
		}
	...
	case *PlaceOrderArgs:
		success, err := handler.(order.CheckoutService).PlaceOrder(ctx, s.Req)
		if err != nil {
			return err
		}
