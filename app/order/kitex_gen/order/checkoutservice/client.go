...
func (p *kCheckoutServiceClient) PlaceOrder(ctx context.Context, Req *order.PlaceOrderRequest, callOptions ...callopt.Option) (r *order.PlaceOrderResponse, err error) {
