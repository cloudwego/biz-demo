...
import (
	...
	"github.com/cloudwego/biz-demo/sample_douyin/cmd/comment/dal"
	douyincomment "github.com/cloudwego/biz-demo/sample_douyin/kitex_gen/douyincomment/commentservice"
...
func main() {
	...
	svr := douyincomment.NewServer(new(CommentServiceImpl),
