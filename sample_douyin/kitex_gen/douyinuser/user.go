...
const (
	...
	ErrCode_QueryErrCode               ErrCode = 10005
)
...
func ErrCodeFromString(s string) (ErrCode, error) {
	...
	case "QueryErrCode":
		return ErrCode_QueryErrCode, nil
	}
...
type User struct {
	...
	WorkCount       int64  `thrift:"work_count,7" frugal:"7,default,i64" json:"work_count"`
	TotalFavorited  int64  `thrift:"total_favorited,8" frugal:"8,default,i64" json:"total_favorited"`
	BackgroundImage string `thrift:"background_image,9" frugal:"9,default,string" json:"background_image"`
...
func (p *User) writeField9(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("background_image", thrift.STRING, 9); err != nil {
		goto WriteFieldBeginError
	}
...
func (p *User) writeField11(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("signature", thrift.STRING, 11); err != nil {
		goto WriteFieldBeginError
	}
...
func (p *User) DeepEqual(ano *User) bool {
	...
	if !p.Field7DeepEqual(ano.WorkCount) {
		return false
	}
	if !p.Field8DeepEqual(ano.TotalFavorited) {
		return false
	}
	if !p.Field9DeepEqual(ano.BackgroundImage) {
		return false
	}
...
type CreateUserRequest struct {
	...
	BackgroundImage string `thrift:"background_image,3" frugal:"3,default,string" json:"background_image"`
...
func (p *CreateUserRequest) GetBackgroundImage() (v string) {
	return p.BackgroundImage
}

func (p *CreateUserRequest) GetAvatar() (v string) {
	return p.Avatar
}
...
func (p *CreateUserRequest) writeField3(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("background_image", thrift.STRING, 3); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteString(p.BackgroundImage); err != nil {
		return err
...
func (p *CreateUserRequest) DeepEqual(ano *CreateUserRequest) bool {
	...
	if !p.Field3DeepEqual(ano.BackgroundImage) {
		return false
	}
